...
//    @Excel(name = "宿舍ID")
    ...
    /** 宿舍使用状态 */
    @Excel(name = "宿舍使用状态", readConverterExp = "1=闲置,2=使用中,3=特殊宿舍闲置,4=特殊宿舍使用中,5=红色驿站闲置,6=红色驿站使用中", prompt = "填写：闲置、使用中、特殊宿舍闲置、特殊宿舍使用中、红色驿站闲置、红色驿站使用中",combo = "闲置,使用中,特殊宿舍闲置,特殊宿舍使用中,红色驿站闲置,红色驿站使用中")
...
//    @Excel(name = "单位负责人联系方式")
    ...
    @Excel(name = "学院",readConverterExp = "205=物理与信息工程学院、微电子学院,204=计算机与大数据学院、软件学院,105=数学与统计学院,210=法学院,103=电气工程与自动化学院,104=机械工程及自动化学院,106=石油化工学院,107=土木工程学院,200=环境与安全工程学院,201=经济与管理学院,202=生物科学与工程学院,203=外国语学院,206=化学学院,207=建筑与城乡规划学院,208=紫金地质与矿业学院,209=材料科学与工程学院,211=人文社会科学学院", prompt = "请从下拉框选择学院或部门（全称）", combo = "物理与信息工程学院、微电子学院,计算机与大数据学院、软件学院,数学与统计学院,法学院,电气工程与自动化学院,机械工程及自动化学院,石油化工学院,土木工程学院,环境与安全工程学院,经济与管理学院,生物科学与工程学院,外国语学院,化学学院,建筑与城乡规划学院,紫金地质与矿业学院,材料科学与工程学院,人文社会科学学院")
    private Long deptId;
